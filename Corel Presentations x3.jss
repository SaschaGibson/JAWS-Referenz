...
; JAWS Script files for Corel Presentations X3
...
If isWritingToolsActive () && (sClass == "PR_TEXTTOOL.13") Then
...
If ! CorelPresentations13FirstTime then
	let CorelPresentations13FirstTime = 1
...
If isWritingToolsActive () && (GetWindowClass (GlobalFocusWindow) == "PR_TEXTTOOL.13") Then
