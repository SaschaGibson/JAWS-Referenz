...
; JAWS Script files for Corel Presentations X6
...
If isWritingToolsActive () && (sClass == "PR_TEXTTOOL.16") Then
...
If ! CorelPresentations16FirstTime then
	let CorelPresentations16FirstTime = 1
...
If isWritingToolsActive () && (GetWindowClass (GlobalFocusWindow) == "PR_TEXTTOOL.16") Then
