; JFW Header File for WordPerfect X6
...
; Window classes
;wc_PFPpreselComboBox="PFPpreselComboBox160",
wc_outlineArray="WP8OutlineArray",
wc_PR_ArrayClass = "PR_ArrayClass.16", ; found in the data sheet view.
wc_glb="GLB160", ; found in the Data sheet, in the Legal dialogue.
wc_bitmapButton="PR_BitmapButton.16",
wc_ButtonEdit="WPfne160",
wc_dateEdit="WPdate160",
wc_spinEdit="WPCNT160",
wc_wpClient="WordPerfect.16.0",
wc_MainDocumentWindow="WPDocClient",
wc_updateStatic160="WPUpdateStatic160",
wc_dialog1="#32770",
wc_dialog2="#32771",
wc_static1="wPStatic160", ; border descriptions use this
wc_StatusBar = "WPTBarWindowClassWP",
wc_popout="WPpopoutbutton.7.32",
wc_WPpopoutwindow = "WPpopoutwindow.7.32",
wc_mru="MRU160",
;wc_pfpMru="PFPI160_MRU",
;wc_pfpPreselButton="PFPpreselButton160",
wc_static="static",
WC_PageSetup = "PFDlgPropPage160",
Wc_Tooltip= "WPCBTAText160",
Wc_toolbar="WPBBar160",
