;Script Message file for Corel Presentations 9 (Service Pack 4)
; Copyright 2010-2015 by Freedom Scientific, Inc.
; build Version 4.0.133
;by Joseph Stephen
; last Modify by: Sean Murphy on 24 oct 2001
...
messages
@msgAppStart1_L
For %product% Hotkey Help with Corel Presentations use %KeyFor(hotkeyHelp).
For a list of Presentations short cut keys use  %KeyFor(WindowKeysHelp).
To hear the %product% help topic for Corel Presentations press %KeyFor(screenSensitiveHelp) twice quickly.
@@
@msgAppStart1_S
hotkey help use %KeyFor(hotkeyHelp).
Presentations shortcut keys use  %KeyFor(WindowKeysHelp).
%product% help topic for Presentations %KeyFor(screenSensitiveHelp) twice quickly.
@@
...
@@
@msgExtendedHelp_L
To hear the %product% help topic for Corel Presentations 9 press %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgExtendedHelp_S
%product% help topic for Corel Presentations 9 %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgAppName
