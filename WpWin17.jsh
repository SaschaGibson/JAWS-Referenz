; JFW Header File for WordPerfect X7
...
wc_PR_ArrayClass = "PR_ArrayClass.17", ; found in the data sheet view.
wc_glb="GLB170", ; found in the Data sheet, in the Legal dialogue.
wc_bitmapButton="PR_BitmapButton.17",
wc_ButtonEdit="WPfne170",
wc_dateEdit="WPdate170",
wc_spinEdit="WPCNT170",
wc_wpClient="WordPerfect.17.0",
wc_MainDocumentWindow="WPDocClient",
wc_updateStatic170="WPUpdateStatic170",
wc_dialog1="#32770",
wc_dialog2="#32771",
wc_static1="wPStatic170", ; border descriptions use this
wc_StatusBar = "WPTBarWindowClassWP",
wc_popout="WPpopoutbutton.7.32",
wc_WPpopoutwindow = "WPpopoutwindow.7.32",
wc_mru="MRU170",
;wc_pfpMru="PFPI170_MRU",
;wc_pfpPreselButton="PFPpreselButton170",
wc_static="static",
WC_PageSetup = "PFDlgPropPage170",
Wc_Tooltip= "WPCBTAText170",
Wc_toolbar="WPBBar170",
