...
; JAWS Script files for Corel Presentations 2020
...
If isWritingToolsActive () && (sClass == "PR_TEXTTOOL.20") Then
...
If ! CorelPresentations20FirstTime then
	let CorelPresentations20FirstTime = 1
...
If isWritingToolsActive () && (GetWindowClass (GlobalFocusWindow) == "PR_TEXTTOOL.20") Then
