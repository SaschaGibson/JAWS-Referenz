...
ksReply="Control+R",
ksReplyToAll="Control+Shift+R",
ksForwardMessage="Control+F",
ksNewMessage="Control+N",
...
;Window names
wn_WindowsMailMessageList="Windows Mail Message List",
...
wn_StyleList="Style:",
;file names
fn_HTMLHelp = "HTML and Windows Help",
...
scNoButton="No",
scGraphicListHelper = "GraphicsListHelper",
scSelectALink = "Select a Link",
scVerticleBar = "|",
...
wn_OutlookExpressMessageList="Outlook Express Message List",
...
@@
@msgHeaderTutor
Press twice to gain focus to the field.
@@
