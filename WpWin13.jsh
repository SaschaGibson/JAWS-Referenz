; JFW Header File for WordPerfect X3
...
; Window classes
;wc_PFPpreselComboBox="PFPpreselComboBox130",
wc_outlineArray="WP8OutlineArray",
wc_PR_ArrayClass = "PR_ArrayClass.13", ; found in the data sheet view.
wc_glb="GLB130", ; found in the Data sheet, in the Legal dialogue.
wc_bitmapButton="PR_BitmapButton.13",
wc_ButtonEdit="WPfne130",
wc_dateEdit="WPdate130",
wc_spinEdit="WPCNT130",
wc_wpClient="WordPerfect.13.0",
wc_MainDocumentWindow="WPDocClient",
wc_updateStatic130="WPUpdateStatic130",
wc_dialog1="#32770",
wc_dialog2="#32771",
wc_static1="wPStatic130", ; border descriptions use this
wc_StatusBar = "WPTBarWindowClassWP",
wc_popout="WPpopoutbutton.7.32",
wc_WPpopoutwindow = "WPpopoutwindow.7.32",
wc_mru="MRU130",
;wc_pfpMru="PFPI130_MRU",
;wc_pfpPreselButton="PFPpreselButton130",
wc_static="static",
WC_PageSetup = "PFDlgPropPage130",
Wc_Tooltip= "WPCBTAText130",
Wc_toolbar="WPBBar130",
