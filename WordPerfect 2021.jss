...
;JAWS Script File for WordPerfect 21.0 (Corel WordPerfect Office 2021)
...
EndIf
if wp21HasRunOnce==false then
	let wp21HasRunOnce=true
...
if (GetScreenEcho() > ECHO_HIGHLIGHTED) ||
	...
	theClass==wc_updateStatic210 then
