;Script Message file for Corel Presentations 2020
...
@@
@msgExtendedHelp_L
To hear the JAWS help topic for Corel Presentations 2020 press %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgExtendedHelp_S
JAWS help topic for Corel Presentations 2020 %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgAppName
