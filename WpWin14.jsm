; JAWS message file FOR WordPerfect X4.
...
After this registry entry is imported, you will need to restart Corel WordPerfect X4 in order for the changes to take effect.

Would you like to import the Windows Registry settings?
@@
@msgImportSuccessful1_L
Registry key imported. Please restart WordPerfect X4.
@@
@msgNotInATable1_L
