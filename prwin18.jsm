;Script Message file for Corel Presentations X8
...
@@
@msgExtendedHelp_L
To hear the JAWS help topic for Corel Presentations X8 press %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgExtendedHelp_S
JAWS help topic for Corel Presentations X8 %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgAppName
