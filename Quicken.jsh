...
wc_QWLabel="QWLabel",
wc_static="Static",
wc_QWNavigator = "QWNavigator",
wc_MainToolbar = "QW_MAIN_TOOLBAR",
...
globals
	; the next 8 are used when learning registry boundaries to summarize a registry line
	; they are the boundaries of the QREdit  box that slides around in the registry
	int QWRFieldCount,
	string QWRRegistryName,
	string QWRFieldNames,
	string QWRFieldRow,
	String QWRFieldLeft,
	string QWRFieldRight,
	string QWRDesiredFields,
	int QWRSpeakFieldLabels,
