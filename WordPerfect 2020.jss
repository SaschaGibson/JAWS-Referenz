...
;JAWS Script File for WordPerfect 20.0 (Corel WordPerfect Office 2020)
...
EndIf
if wp20HasRunOnce==false then
	let wp20HasRunOnce=true
...
if (GetScreenEcho() > ECHO_HIGHLIGHTED) ||
	...
	theClass==wc_updateStatic200 then
