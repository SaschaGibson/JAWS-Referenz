; JAWS message file FOR WordPerfect 2021.
...
After this registry entry is imported, you will need to restart Corel WordPerfect 2021 in order for the changes to take effect.

Would you like to import the Windows Registry settings?
@@
@msgImportSuccessful1_L
Registry key imported. Please restart WordPerfect 2021.
@@
@msgNotInATable1_L
