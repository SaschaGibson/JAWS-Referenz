...
; Window classes
;wc_PFPpreselComboBox="PFPpreselComboBox100",
wc_outlineArray="WP8OutlineArray",
wc_PR_ArrayClass = "PR_ArrayClass.10", ; found in the data sheet view.
wc_glb="GLB100", ; found in the Data sheet, in the Legal dialogue.
wc_bitmapButton="PR_BitmapButton.10",
wc_ButtonEdit="WPfne100",
wc_dateEdit="WPdate100",
wc_spinEdit="WPCNT100",
wc_wpClient="WordPerfect.10.0",
wc_MainDocumentWindow="WPDocClient",
wc_updateStatic90="WPUpdateStatic100",
wc_dialog1="#32770",
wc_dialog2="#32771",
wc_static1="wPStatic100", ; border descriptions use this
wc_StatusBar = "WPTBarWindowClassWP",
wc_popout="WPpopoutbutton.7.32",
wc_WPpopoutwindow = "WPpopoutwindow.7.32",
wc_mru="MRU100",
;wc_pfpMru="PFPI90_MRU",
;wc_pfpPreselButton="PFPpreselButton100",
wc_static="static",
WC_PageSetup = "PFDlgPropPage100",
Wc_Tooltip= "WPCBTAText100",
Wc_toolbar="WPBBar100",
