...
To say balances on this screen use  %KeyFor(balancesSay).
To hear running balance as of the current entry, press %KeyFor(InsertPageUp).
To list the toolbar buttons use  %KeyFor(toolbarButtonsList).
...
@@
@QWMsgQuicken1_L
Quicken 2003 scripts version 1.0
@@
@QWMsgOutOfLink1
out of link
@@
...
To explore the lots for a given security, down arrow to the security.  Route JAWS ToPC.
...
If you wish to explore details about a security, Position to that security, route JAWS to pc, and left click on the
