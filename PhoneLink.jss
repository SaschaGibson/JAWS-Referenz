...
; JAWS script file for the Phone Link app

include "hjconst.jsh"
include "UIA.jsh"
include "common.jsm"
include "PhoneLink.jsm"
import "UIA.jsd"

const
	PhoneLinkUIAEventPrefix = "PhoneLinkUIA",
...
ScriptAndAppNames(msgPhoneLinkAppName) ;"Phone Link"
EndScript
...
if !InSuggestionList()
	...
	endIf
	giScheduledSaySuggestionCount = ScheduleFunction ("SaySuggestionCount", 6)
endIf
endFunction
...
|| !ComAttachEvents (oSearchTextListener, PhoneLinkUIAEventPrefix)
...
void function PhoneLinkUIAAutomationEvent (object element, int eventID)
