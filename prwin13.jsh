;Script header file for Corel Presentations 13
...
wc_PRArray="PR_ArrayClass.13",
wc_bitmapButton="PR_BitmapButton.13",
wc_Dialog="#32770",
wc_slideShowRunning="PR_SlideShow.13",
wc_PRGLB="PRGLB",
wc_charMapGrid="WPChrMapGrid130",
wc_drawArea="PR_DrawAreaChild.13",
wc_glb="GLB130",
...
Globals
	int CorelPresentations13FirstTime,
	int nSuppressEcho,
