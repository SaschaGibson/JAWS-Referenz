; JFW Header File for WordPerfect 2020
...
wc_PR_ArrayClass = "PR_ArrayClass.20", ; found in the data sheet view.
wc_glb="GLB200", ; found in the Data sheet, in the Legal dialogue.
wc_bitmapButton="PR_BitmapButton.20",
wc_ButtonEdit="WPfne200",
wc_dateEdit="WPdate200",
wc_spinEdit="WPCNT200",
wc_wpClient="WordPerfect.20.0",
wc_MainDocumentWindow="WPDocClient",
wc_updateStatic200="WPUpdateStatic200",
wc_dialog1="#32770",
wc_dialog2="#32771",
wc_static1="wPStatic200", ; border descriptions use this
wc_StatusBar = "WPTBarWindowClassWP",
wc_popout="WPpopoutbutton.7.32",
wc_WPpopoutwindow = "WPpopoutwindow.7.32",
wc_mru="MRU200",
;wc_pfpMru="PFPI200_MRU",
;wc_pfpPreselButton="PFPpreselButton200",
wc_static="static",
WC_PageSetup = "PFDlgPropPage200",
Wc_Tooltip= "WPCBTAText200",
Wc_toolbar="WPBBar200",
