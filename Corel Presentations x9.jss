...
; JAWS Script files for Corel Presentations X9
...
If isWritingToolsActive () && (sClass == "PR_TEXTTOOL.19") Then
...
If ! CorelPresentations19FirstTime then
	let CorelPresentations19FirstTime = 1
...
If isWritingToolsActive () && (GetWindowClass (GlobalFocusWindow) == "PR_TEXTTOOL.19") Then
