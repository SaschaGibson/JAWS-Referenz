...
; JAWS 12.0.xx header file for Office 2007
...
; for headings announcement independent of other style changes in Outlook 2007 and Word:
	int giMSOfficeHeadingIndication,
; for when ribbon had focus and app has lost it:
; set FocusChangedEventEx in msoffice2007 and clear it in SayFocusedWindow in app.
...
;used by FocusChangedEventEx inmsoffice2007.hss, and by NewTextEvent  and  Enter script and SayFocusedWindow in microsoft word 2007.jss.
