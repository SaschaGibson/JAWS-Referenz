;Script header file for Corel Presentations 16
...
wc_PRArray="PR_ArrayClass.16",
wc_bitmapButton="PR_BitmapButton.16",
wc_Dialog="#32770",
wc_slideShowRunning="PR_SlideShow.16",
wc_PRGLB="PRGLB",
wc_charMapGrid="WPChrMapGrid160",
wc_drawArea="PR_DrawAreaChild.16",
wc_glb="GLB160",
...
Globals
	int CorelPresentations16FirstTime,
	int nSuppressEcho,
