; JAWS message file FOR WordPerfect X8.
...
After this registry entry is imported, you will need to restart Corel WordPerfect X8 in order for the changes to take effect.

Would you like to import the Windows Registry settings?
@@
@msgImportSuccessful1_L
Registry key imported. Please restart WordPerfect X8.
@@
@msgNotInATable1_L
