; JFW Header File for WordPerfect X4
...
wc_PR_ArrayClass = "PR_ArrayClass.14", ; found in the data sheet view.
wc_glb="GLB140", ; found in the Data sheet, in the Legal dialogue.
wc_bitmapButton="PR_BitmapButton.14",
wc_ButtonEdit="WPfne140",
wc_dateEdit="WPdate140",
wc_spinEdit="WPCNT140",
wc_wpClient="WordPerfect.14.0",
wc_MainDocumentWindow="WPDocClient",
wc_updateStatic140="WPUpdateStatic140",
wc_dialog1="#32770",
wc_dialog2="#32771",
wc_static1="wPStatic140", ; border descriptions use this
wc_StatusBar = "WPTBarWindowClassWP",
wc_popout="WPpopoutbutton.7.32",
wc_WPpopoutwindow = "WPpopoutwindow.7.32",
wc_mru="MRU140",
;wc_pfpMru="PFPI140_MRU",
;wc_pfpPreselButton="PFPpreselButton140",
wc_static="static",
WC_PageSetup = "PFDlgPropPage140",
Wc_Tooltip= "WPCBTAText140",
Wc_toolbar="WPBBar140",
