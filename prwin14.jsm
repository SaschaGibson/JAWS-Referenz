;Script Message file for Corel Presentations X4
...
@@
@msgExtendedHelp_L
To hear the JAWS help topic for Corel Presentations X4 press %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgExtendedHelp_S
JAWS help topic for Corel Presentations X4 %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgAppName
