; JFW 7.10 Header File for Wordperfect 12
...
; The following two are found in the Save As dialog, the two check boxes preceeding the Save button
cId_PasswordProtectDocument = 3223,
cID_EmbedFonts = 3224,
; Window classes
;wc_PFPpreselComboBox="PFPpreselComboBox120",
wc_outlineArray="WP8OutlineArray",
wc_PR_ArrayClass = "PR_ArrayClass.12", ; found in the data sheet view.
wc_glb="GLB120", ; found in the Data sheet, in the Legal dialogue.
wc_bitmapButton="PR_BitmapButton.12",
wc_ButtonEdit="WPfne120",
wc_dateEdit="WPdate120",
wc_spinEdit="WPCNT120",
wc_wpClient="WordPerfect.12.0",
wc_MainDocumentWindow="WPDocClient",
wc_updateStatic90="WPUpdateStatic120",
wc_dialog1="#32770",
wc_dialog2="#32771",
wc_static1="wPStatic120", ; border descriptions use this
wc_StatusBar = "WPTBarWindowClassWP",
wc_popout="WPpopoutbutton.7.32",
wc_WPpopoutwindow = "WPpopoutwindow.7.32",
wc_mru="MRU120",
;wc_pfpMru="PFPI90_MRU",
;wc_pfpPreselButton="PFPpreselButton120",
wc_static="static",
WC_PageSetup = "PFDlgPropPage120",
Wc_Tooltip= "WPCBTAText120",
Wc_toolbar="WPBBar120",
