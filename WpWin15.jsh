; JFW Header File for WordPerfect X5
...
wc_PR_ArrayClass = "PR_ArrayClass.15", ; found in the data sheet view.
wc_glb="GLB150", ; found in the Data sheet, in the Legal dialogue.
wc_bitmapButton="PR_BitmapButton.15",
wc_ButtonEdit="WPfne150",
wc_dateEdit="WPdate150",
wc_spinEdit="WPCNT150",
wc_wpClient="WordPerfect.15.0",
wc_MainDocumentWindow="WPDocClient",
wc_updateStatic150="WPUpdateStatic150",
wc_dialog1="#32770",
wc_dialog2="#32771",
wc_static1="wPStatic150", ; border descriptions use this
wc_StatusBar = "WPTBarWindowClassWP",
wc_popout="WPpopoutbutton.7.32",
wc_WPpopoutwindow = "WPpopoutwindow.7.32",
wc_mru="MRU150",
;wc_pfpMru="PFPI150_MRU",
;wc_pfpPreselButton="PFPpreselButton150",
wc_static="static",
WC_PageSetup = "PFDlgPropPage150",
Wc_Tooltip= "WPCBTAText150",
Wc_toolbar="WPBBar150",
