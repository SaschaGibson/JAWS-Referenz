;Script Message file for Corel Presentations X9
...
@@
@msgExtendedHelp_L
To hear the JAWS help topic for Corel Presentations X9 press %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgExtendedHelp_S
JAWS help topic for Corel Presentations X9 %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgAppName
