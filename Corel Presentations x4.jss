...
; JAWS Script files for Corel Presentations X4
...
If isWritingToolsActive () && (sClass == "PR_TEXTTOOL.14") Then
...
If ! CorelPresentations14FirstTime then
	let CorelPresentations14FirstTime = 1
...
If isWritingToolsActive () && (GetWindowClass (GlobalFocusWindow) == "PR_TEXTTOOL.14") Then
