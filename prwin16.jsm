;Script Message file for Corel Presentations X6
...
@@
@msgExtendedHelp_L
To hear the JAWS help topic for Corel Presentations X6 press %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgExtendedHelp_S
JAWS help topic for Corel Presentations X6 %KeyFor(screenSensitiveHelp) twice quickly
@@
@msgAppName
