...
; JAWS Script files for Corel Presentations X5
...
If isWritingToolsActive () && (sClass == "PR_TEXTTOOL.15") Then
...
If ! CorelPresentations15FirstTime then
	let CorelPresentations15FirstTime = 1
...
If isWritingToolsActive () && (GetWindowClass (GlobalFocusWindow) == "PR_TEXTTOOL.15") Then
