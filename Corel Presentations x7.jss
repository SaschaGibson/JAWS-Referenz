...
; JAWS Script files for Corel Presentations X7
...
If isWritingToolsActive () && (sClass == "PR_TEXTTOOL.17") Then
...
If ! CorelPresentations17FirstTime then
	let CorelPresentations17FirstTime = 1
...
If isWritingToolsActive () && (GetWindowClass (GlobalFocusWindow) == "PR_TEXTTOOL.17") Then
